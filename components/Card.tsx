...
export function Card(props: CardProps) {
    ...
    const divClassName = project.nameClasses ?
                         (project.nameClasses as string) + " justify-between font-display ":
                         "text-white justify-between text-3xl sm:text-3xl font-display";
